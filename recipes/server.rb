...
boxstarter "boxstarter install SQL Server" do
  ...
  code <<-EOH
  	$SQLArgs = '/SECURITYMODE=SQL /SAPWD="#{node['test_kitchen_mssql_helpers']['sa_password']}" /TCPENABLED=1'
	[Environment]::SetEnvironmentVariable("chocolateyInstallArguments",$SQLArgs,"Machine")
...
$tcp = $mc.GetSmoObject("ManagedComputer[@Name='$env:computername']/ ServerInstance[@Name='SQLEXPRESS']/ServerProtocol[@Name='Tcp']")
